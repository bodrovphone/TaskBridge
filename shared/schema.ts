...
export const tasks = pgTable("tasks", {
  ...
  budgetType: varchar("budget_type", { enum: ["range", "fixed"] }).default("range"),
  city: varchar("city").notNull(),
  neighborhood: varchar("neighborhood"),
  exactAddress: text("exact_address"),
  deadline: timestamp("deadline"),
  urgency: varchar("urgency", { enum: ["same_day", "within_week", "flexible"] }).default("flexible"),
  requirements: text("requirements"),
  photos: text("photos").array(),
  status: varchar("status", { enum: ["open", "in_progress", "completed", "cancelled", "expired"] }).default("open"),
...
export const reviews = pgTable("reviews", {
  ...
  reviewerType: varchar("reviewer_type", { enum: ["customer", "professional"] }).notNull(),
...
export const TASK_SUBCATEGORIES = {
  "home_repair": ["Електричество", "Водопровод", "Почистване", "Поддръжка", "Преместване"],
  "delivery_transport": ["Доставка на пакети", "Пазаруване", "Транспорт", "Куриерски услуги"],
  "personal_care": ["Грижа за домашни любимци", "Детегледане", "Грижа за възрастни", "Разходка с куче"],
  "personal_assistant": ["Административни задачи", "Поръчки", "Помощ при събития", "Лични поръчки"],
  "learning_fitness": ["Частни уроци", "Персонален тренинг", "Езикови уроци", "Музикални уроци"],
  "other": ["Други услуги"]
} as const;
