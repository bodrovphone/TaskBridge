...
import { ChevronLeft, MapPin, Clock, Wallet, Star, CheckCircle, Calendar } from "lucide-react";
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-gray-900">{task.applicationsCount} {t('taskDetail.applications')}</p>
                    </div>
                  </div>
                </div>
              </CardBody>
