    ...
    <>
      ...
      <div className="bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 -mt-16 pt-20 pb-10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white min-h-[150px] md:min-h-[300px] flex items-center justify-center">
          ...
          >
              ...
              >
                <div className="bg-white/10 backdrop-blur-md rounded-full px-6 py-2 border border-white/20 mb-6">
              ...
              >
                {[
                  ...
                  <motion.div
                    ...
                    className="bg-white/10 backdrop-blur-md rounded-xl px-4 py-3 border border-white/20 text-center min-w-[140px]"
                  >
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-30 pb-16">
          ...
          >
            <NextUICard className="bg-white/98 backdrop-blur-xl shadow-2xl border-0 max-w-5xl mx-auto overflow-hidden">
