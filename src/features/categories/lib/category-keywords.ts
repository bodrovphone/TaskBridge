...
export const CATEGORY_KEYWORDS: CategoryKeywords = {
  ...
  'ac-maintenance': {
    en: ['air conditioner', 'ac', 'ac repair', 'ac service', 'ac maintenance', 'hvac', 'cooling', 'air conditioning', 'ac cleaning', 'ac unit', 'split system', 'air con', 'ac installation', 'refrigerant', 'ac filter', 'ac not cooling', 'ac not working', 'fix ac', 'repair ac'],
    bg: ['климатик', 'климатици', 'ремонт климатик', 'сервиз климатик', 'почистване климатик', 'зареждане климатик', 'фреон', 'хладилен агент', 'климатична система', 'монтаж климатик', 'демонтаж климатик', 'климатик не охлажда', 'климатик не работи', 'сплит система', 'инверторен климатик', 'профилактика климатик'],
    ru: ['кондиционер', 'кондиционеры', 'ремонт кондиционера', 'чистка кондиционера', 'заправка кондиционера', 'фреон', 'сплит система', 'обслуживание кондиционера', 'монтаж кондиционера', 'демонтаж кондиционера', 'кондиционер не холодит', 'кондиционер не работает', 'починить кондиционер', 'сервис кондиционера', 'профилактика кондиционера', 'климат контроль'],
  },
  ...
  'heating-installation': {
    en: ['heating', 'radiator', 'boiler', 'central heating', 'underfloor heating', 'heat pump', 'furnace', 'thermostat', 'heating system'],
    bg: ['отопление', 'радиатор', 'котел', 'парно', 'подово отопление', 'термостат', 'отоплителна система', 'газов котел'],
    ru: ['отопление', 'радиатор', 'котел', 'батарея', 'теплый пол', 'термостат', 'отопительная система', 'газовый котел'],
  },
  ...
  'passenger-transfer': {
    en: ['transfer', 'driver', 'personal driver', 'ride', 'drive me', 'airport transfer', 'intercity', 'intercity transfer', 'chauffeur', 'private driver', 'need a ride', 'taxi', 'long distance', 'city to city', 'airport pickup', 'airport drop'],
    bg: ['трансфер', 'шофьор', 'личен шофьор', 'превоз', 'откарай ме', 'летищен трансфер', 'между градове', 'междуградски', 'такси', 'до летището', 'от летището', 'превоз до', 'откарване'],
    ru: ['трансфер', 'водитель', 'личный водитель', 'подвезти', 'довезти', 'отвезти', 'междугородний', 'межгород', 'в другой город', 'аэропорт', 'трансфер в аэропорт', 'такси межгород', 'дальняя поездка', 'нужен водитель', 'подвоз'],
  },
