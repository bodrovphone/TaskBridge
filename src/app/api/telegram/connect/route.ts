...
async function sendConfirmationMessage(telegramId: number, locale: string = 'en') {
  ...
  const lang = locale.startsWith('bg') ? 'bg'
    : locale.startsWith('ru') ? 'ru'
    : locale.startsWith('ua') ? 'ua'
    : 'en';
  ...
  const confirmationMessages: Record<string, string> = {
    ...
    ua: `✅ <b>Успішно підключено!</b>\n\nВаш Telegram акаунт тепер підключено до Trudify.\n\n<b>Ви отримуватимете миттєві сповіщення про:</b>\n• Нові заявки на ваші завдання\n• Оновлення статусу заявок\n• Нові повідомлення від клієнтів/фахівців\n• Підтвердження завершення завдань\n\nВи можете керувати налаштуваннями сповіщень у своєму профілі на сайті.`
  };
