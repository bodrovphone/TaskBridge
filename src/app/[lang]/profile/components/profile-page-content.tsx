...
export function ProfilePageContent({ lang }: ProfilePageContentProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-white/60 via-white/40 to-blue-50/50 backdrop-blur-[0.5px]"></div>
      ...
      {/* Profile Header */}
      <div className="mb-8">
        <Card className="shadow-2xl border border-white/20 bg-white/95 backdrop-blur-sm hover:shadow-blue-500/10 transition-shadow duration-300">
      ...
      {/* Profile Tabs */}
      <div className="mb-6">
        <Card className="shadow-xl border border-white/20 bg-white/95 backdrop-blur-sm hover:shadow-2xl transition-shadow duration-300">
