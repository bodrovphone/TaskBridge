        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-lg font-bold text-gray-900 mb-1">
              ✉️ {t('profile.email.checkInboxTitle', 'Check Your Inbox!')}
            </h3>
            <p className="text-sm text-gray-600 mb-3">
              {t('profile.email.checkInboxMessage', 'We sent a verification email to your inbox. Please click the link in the email to verify your address.')}
            </p>
            <p className="text-xs text-gray-500">
              {t('profile.email.checkSpam', "Didn't receive it? Check your spam folder or click the button below to resend.")}
            </p>
          </div>
