...
export const applications = {
  ...
  'application.pricePlaceholder': 'Enter your price in EUR',
  ...
  'application.viewApplication': 'My Application',
  'application.browseOther': 'Browse Tasks',
  ...
  'application.tipClientBudget': 'Tip: Client budget is {min} - {max} €',
