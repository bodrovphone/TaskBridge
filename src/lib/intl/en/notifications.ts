...
export const notifications = {
  ...
  'taskDetail.contactReveal.showContact': 'Show contact',
  'taskDetail.contactReveal.signInToSee': 'Sign in to see contact',
  'taskDetail.contactReveal.revealedTitle': 'Customer contact',
  'taskDetail.contactReveal.noPhone': 'No phone on file — use the apply form below to message the customer.',
  'taskDetail.contactReveal.error': 'Could not reveal contact',
  ...
  'taskDetail.urgency.same_day': 'Urgent',
  ...
  'taskDetail.originallyWrittenIn': 'Originally written in',
  ...
  'customerRemove.feedbackLabel': 'Feedback for the professional (optional)',
  'customerRemove.feedbackPlaceholder': 'Let them know why you\'re removing them from this task...',
  'customerRemove.feedbackHint': 'This message will be included in the notification sent to the professional.',
