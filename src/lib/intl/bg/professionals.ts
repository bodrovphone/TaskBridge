...
export const professionals = {
  ...
  'professionals.suggestTask': 'Предложете задача',
  ...
  'professionalDetail.anonymous': 'Анонимен',
  ...
  'professionalDetail.actions.suggestMyTask': 'Предложи моята задача',
  'professionalDetail.actions.invite': 'Покани',
  ...
  'professionalDetail.gallery.title': 'Галерия с работи',
  'professionalDetail.gallery.subtitle': 'Примери за завършена работа',
  'professionalDetail.gallery.imageView': 'Преглед на изображение',
  ...
  'inviteModal.createTaskHint': 'Първо създайте задача, за да поканите този професионалист.',
