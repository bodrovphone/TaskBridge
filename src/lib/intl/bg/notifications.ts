...
export const notifications = {
  ...
  'notifications.content.removedByCustomer.message': 'Бяхте премахнат от задачата "{{taskTitle}}" от клиента.',
  ...
  'customerRemove.limitWarning.message': 'Клиентите могат да премахват до {{max}} специалист месечно. Честите премахвания могат да показват лош избор при наемане.',
  ...
  'customerRemove.reasonLabel': 'Защо премахвате този специалист?',
  'customerRemove.reasons.professional_unresponsive': 'Специалистът не отговаря на съобщения',
  'customerRemove.reasons.professional_no_show': 'Специалистът пропусна уговорени срещи',
  'customerRemove.reasons.quality_concerns': 'Качеството на работата не отговаря на стандартите',
  'customerRemove.reasons.safety_issues': 'Опасения за безопасността на работата',
  'customerRemove.reasons.timeline_issue': 'Не може да спази моя краен срок',
  'customerRemove.reasons.scope_disagreement': 'Несъгласие относно обхвата или цената',
  'customerRemove.reasons.my_circumstances_changed': 'Моите обстоятелства се промениха',
  'customerRemove.reasons.mutual_agreement': 'Взаимно съгласие за прекратяване',
  'customerRemove.reasons.other': 'Друга причина',
  'customerRemove.descriptionLabel': 'Допълнителни детайли (по избор)',
  'customerRemove.descriptionPlaceholder': 'Моля, обяснете ситуацията...',
  'customerRemove.descriptionHint': 'Това ни помага да подобрим платформата',
