...
export const notifications = {
  ...
  'notifications.content.taskCompleted.message': '{{professionalName}} маркира вашата задача "{{taskTitle}}" като завършена. Моля, прегледайте и потвърдете.',
