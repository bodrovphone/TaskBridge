...
export const notifications = {
  ...
  'taskDetail.contactReveal.showContact': 'Покажи контакт',
  'taskDetail.contactReveal.signInToSee': 'Влезте, за да видите контакт',
  'taskDetail.contactReveal.revealedTitle': 'Контакт на клиента',
  'taskDetail.contactReveal.noPhone': 'Няма телефон в профила — използвайте формата по-долу, за да се свържете.',
  'taskDetail.contactReveal.error': 'Контактът не може да бъде показан',
