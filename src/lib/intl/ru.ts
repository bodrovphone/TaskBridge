const ru = {
  ...
  'categories.sub.moving_service': 'Услуги переезда',
  'categories.sub.cargo_transport': 'Грузоперевозки',
  'categories.sub.loaders': 'Грузчики',
  'categories.sub.furniture_moving': 'Перевозка мебели',
  'categories.sub.waste_removal': 'Вывоз мусора',
  'categories.sub.apartment_cleaning': 'Уборка квартиры',
  'categories.sub.deep_cleaning': 'Генеральная уборка',
  'categories.sub.post_renovation_cleaning': 'Уборка после ремонта',
  'categories.sub.house_cleaning': 'Уборка дома',
