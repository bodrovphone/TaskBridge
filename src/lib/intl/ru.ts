const ru = {
  ...
  'myApplications.appliedOn': 'Подана',
  'myApplications.respondedOn': 'Ответили',
  ...
  'myApplications.deleteApplication': 'Удалить',
  ...
  'myApplications.emptyState.browseTasks': 'Просмотреть задачи',

  // Application Detail Modal
  'myApplications.detail.title': 'Детали заявки',
  'myApplications.detail.taskDetails': 'Детали задачи',
  'myApplications.detail.customerInfo': 'Информация о клиенте',
  'myApplications.detail.yourProposal': 'Ваше предложение',
  'myApplications.detail.proposedPrice': 'Предложенная цена',
  'myApplications.detail.timeline': 'Сроки',
  'myApplications.detail.message': 'Сообщение',
  'myApplications.detail.applicationDate': 'Дата подачи заявки',
  'myApplications.detail.responseDate': 'Дата ответа',
  ...
  'myApplications.detail.confirmStartDate': 'Подтвердите дату начала',
  'myApplications.detail.completeTask': 'Выполните задачу профессионально',
  'myApplications.detail.markWhenDone': 'Отметьте задачу как завершенную',
  'myApplications.detail.contactInfo': 'Контактная информация',
  'myApplications.detail.notSelected': 'К сожалению, клиент выбрал другого специалиста',
  ...
  'myApplications.detail.applicationWithdrawn': 'Вы отозвали эту заявку',
  'myApplications.detail.cannotReapply': 'Вы не можете подать повторную заявку на эту задачу.',
  'myApplications.detail.taskStarted': 'Задача начата',
  'myApplications.detail.startedOn': 'Начата',
  'myApplications.detail.taskCompleted': 'Задача завершена',
  'myApplications.detail.completedOn': 'Завершена',
  'myApplications.detail.awaitingReview': 'Ожидание отзыва клиента',

  // Withdraw Dialog
  'myApplications.withdrawDialog.title': 'Отозвать заявку?',
  'myApplications.withdrawDialog.taskInfo': 'Информация о задаче',
  'myApplications.withdrawDialog.customer': 'Клиент',
  'myApplications.withdrawDialog.yourQuote': 'Ваша цена',
  'myApplications.withdrawDialog.warning': 'Это действие нельзя отменить. После отзыва заявки вы не сможете подать ее повторно на эту задачу.',
  'myApplications.withdrawDialog.reason': 'Причина отзыва (необязательно)',
  'myApplications.withdrawDialog.reasonHelp': 'Указание причины помогает нам улучшить платформу.',
  ...
  'taskStatus.pendingProfessionalConfirmation': 'Ожидание подтверждения специалиста',
  'taskStatus.pendingCustomerConfirmation': 'Ожидание подтверждения клиента',
  'taskStatus.completed': 'Завершена',
  'taskStatus.cancelled': 'Отменена',
  'taskStatus.disputed': 'Оспаривается',
  ...
  'taskStatus.pendingProfessionalConfirmationTooltip': 'Ожидание подтверждения завершения от специалиста',
  'taskStatus.pendingCustomerConfirmationTooltip': 'Ожидание подтверждения завершения от клиента',
  ...
  'taskCompletion.markDialog.description': 'Вы собираетесь отметить эту задачу как завершённую. Пожалуйста, подтвердите, что работа выполнена надлежащим образом.',
  'taskCompletion.markDialog.checklist': 'Контрольный список завершения',
  'taskCompletion.markDialog.requirementsCompleted': 'Я выполнил все требования задачи',
  'taskCompletion.markDialog.customerSatisfied': 'Клиент удовлетворён результатами работы',
  'taskCompletion.markDialog.photoUploadTitle': 'Фотографии завершения (необязательно)',
  'taskCompletion.markDialog.photoUploadHelp': 'Загрузите до 5 фотографий завершённой работы',
  'taskCompletion.markDialog.uploadPhotos': 'Загрузить фотографии',
  'taskCompletion.markDialog.removePhoto': 'Удалить',
  'taskCompletion.markDialog.notesTitle': 'Заметки о завершении (необязательно)',
  'taskCompletion.markDialog.notesPlaceholder': 'Добавьте любые дополнительные детали о выполненной работе...',
  'taskCompletion.markDialog.nextStepsTitle': 'Что происходит дальше?',
  'taskCompletion.markDialog.nextStepsDescription': 'После того, как вы отметите задачу как завершённую, клиент получит уведомление для проверки и подтверждения работы. После подтверждения обеими сторонами задача будет помечена как завершённая.',
  'taskCompletion.markDialog.cancel': 'Отмена',
  'taskCompletion.markDialog.submit': 'Отметить как завершённую',

  // Confirm Completion Dialog (Customer)
  'taskCompletion.confirmDialog.title': 'Подтвердить завершение задачи',
  'taskCompletion.confirmDialog.description': '{{name}} отметил эту задачу как завершённую. Пожалуйста, проверьте работу и подтвердите, что вы удовлетворены.',
  ...
  'taskCompletion.confirmDialog.satisfiedTitle': 'Отлично! Вы можете подтвердить завершение',
  'taskCompletion.confirmDialog.satisfiedDescription': 'После подтверждения задача будет помечена как завершённая, и вы сможете оставить отзыв о {{name}}.',
  'taskCompletion.confirmDialog.cancel': 'Отмена',
  'taskCompletion.confirmDialog.confirm': 'Подтвердить завершение',

  // Reject Completion
  'taskCompletion.reject.title': 'Укажите свои замечания',
  'taskCompletion.reject.description': 'Пожалуйста, сообщите {{name}}, что нужно исправить. Задача вернётся в статус "В процессе".',
  'taskCompletion.reject.reasonLabel': 'Причина отклонения',
  ...
  'taskCompletion.reject.descriptionLabel': 'Опишите проблему',
  'taskCompletion.reject.descriptionPlaceholder': 'Пожалуйста, опишите конкретно, что нужно исправить...',
  ...
  'myApplications.filter.pending': 'Ожидающие',
  'myApplications.filter.accepted': 'Принятые',
  'myApplications.filter.rejected': 'Отклонённые',
  ...
  'myApplications.empty.message': 'Вы ещё не подали заявки на задачи. Просмотрите доступные задачи!',
