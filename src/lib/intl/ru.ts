const ru = {
  ...
  'categories.sub.plumbing': 'Сантехника',
  'categories.sub.electrician': 'Электрик',
  'categories.sub.handyman': 'Мастер на все руки',
  'categories.sub.locksmith': 'Замочник',
  'categories.sub.carpenter': 'Плотник',
  'categories.sub.appliance_repair': 'Ремонт бытовой техники',
  'categories.sub.apartment_renovation': 'Ремонт квартиры',
  'categories.sub.tile_installation': 'Укладка плитки',
  'categories.sub.painting': 'Покраска',
  'categories.sub.plastering': 'Штукатурка',
  'categories.sub.bricklaying': 'Кладка кирпича',
  'categories.sub.general_labor': 'Общестроительные работы',
  'categories.sub.moving-service': 'Услуги переезда',
  'categories.sub.cargo-transport': 'Грузоперевозки',
  'categories.sub.loaders': 'Грузчики',
  'categories.sub.furniture_moving': 'Перевозка мебели',
  'categories.sub.waste_removal': 'Вывоз мусора',
  'categories.sub.apartment-cleaning': 'Уборка квартиры',
  'categories.sub.deep-cleaning': 'Генеральная уборка',
  'categories.sub.post_renovation_cleaning': 'Уборка после ремонта',
  'categories.sub.house-cleaning': 'Уборка дома',
  'categories.sub.office_cleaning': 'Уборка офиса',
  'categories.sub.babysitting': 'Няня',
  'categories.sub.caregiver': 'Сиделка',
  'categories.sub.housekeeper': 'Домработница',
  'categories.sub.tutoring': 'Репетиторство',
  'categories.sub.pet_care': 'Присмотр за животными',
  'categories.sub.computer_repair': 'Ремонт компьютеров',
  'categories.sub.phone_repair': 'Ремонт телефонов',
  'categories.sub.it_support': 'IT поддержка',
  'categories.sub.web_development': 'Веб-разработка',
  'categories.sub.digital_marketing': 'Цифровой маркетинг',
