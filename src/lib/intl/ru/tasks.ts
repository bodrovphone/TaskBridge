...
export const tasks = {
  ...
  'browseTasks.search.searchButton': 'Поиск',
  ...
  'browseTasks.filters.urgentSameDay': 'Срочно',
  ...
  'browseTasks.results.allTasksLoaded': 'Вы достигли конца списка',
  'browseTasks.results.loadingMore': 'Загрузка ещё задач...',
  ...
  'createTask.timeline.urgentTitle': 'Срочно',
  'createTask.timeline.urgentDesc': 'Как можно скорее',
  ...
  'createTask.contactConsent.title': 'Ваш контакт будет показан заинтересованным специалистам',
  'createTask.contactConsent.body': 'Когда вы опубликуете задачу, специалисты, желающие её выполнить, смогут увидеть ваше имя и номер телефона, чтобы связаться с вами напрямую. Нажимая "Опубликовать задачу", вы соглашаетесь с этим.',
  ...
  'taskCard.time.thisWeek': 'на этой неделе',
  'taskCard.time.thisMonth': 'в этом месяце',
