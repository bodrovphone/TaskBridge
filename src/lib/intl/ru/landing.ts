...
export const landing = {
  'landing.hero.badge': 'Платформа услуг #1 в Болгарии',
  'landing.hero.title': 'Ищете работу или мастера?',
  ...
  'landing.howItWorks.customersLearnMore': 'Смотреть видео гайды',
  'landing.howItWorks.professionalsLearnMore': 'Смотреть видео гайды',
  ...
  'landing.cta.joinProfessionals': 'Я специалист',
  'landing.cta.freeToJoin': 'Бесплатно, без комиссий',
