...
export const notifications = {
  ...
  'notifications.content.taskCompleted.message': '{{professionalName}} отметил вашу задачу "{{taskTitle}}" как выполненную. Пожалуйста, проверьте и подтвердите.',
