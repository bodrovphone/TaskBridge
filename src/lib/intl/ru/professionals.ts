...
export const professionals = {
  ...
  'professionals.results.featured.title': 'Рекомендуемые специалисты',
  'professionals.results.featured.description': 'Посмотрите этих высоко оцененных специалистов из нашей сети',
  'professionals.results.showing': 'Показано {{count}} специалистов',
  'professionals.results.showing_zero': 'Показано 0 специалистов',
  'professionals.results.showing_one': 'Показан 1 специалист',
  'professionals.results.showing_other': 'Показано {{count}} специалистов',
  'professionals.results.loading': 'Загрузка специалистов...',
