...
const mockProfessionals: ApplicationProfessional[] = [
  ...
  },
  {
    ...
    rating: 4.9,
    completedTasks: 67,
    specializations: ['Electrical', 'Installation', 'Certified'],
  ...
  },
  {
    ...
    rating: 4.6,
    completedTasks: 32,
    specializations: ['Carpentry', 'Furniture', 'Custom Work'],
  ...
  },
  {
    ...
    rating: 4.7,
    completedTasks: 53,
    specializations: ['Painting', 'Wallpaper', 'Interior'],
    reviews: mockReviews,
    yearsOfExperience: 6,
    verified: true
  },
  {
    ...
    rating: 4.5,
    completedTasks: 28,
    specializations: ['HVAC', 'Heating', 'Cooling'],
