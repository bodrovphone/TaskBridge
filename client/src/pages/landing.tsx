    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section id="testimonials" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Final CTA Section */}
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary-600 via-primary-500 to-secondary-600 p-8 lg:p-16">
            {/* Background pattern */}
            <div className="absolute inset-0 opacity-10">
            ...
            <div className="relative text-center text-white">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10 max-w-4xl mx-auto">
                <div className="text-center">
                  ...
                  <div className="text-white/80 text-sm lg:text-base">{t('landing.cta.stats.completedTasks')}</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl lg:text-4xl font-bold mb-2">850+</div>
                  <div className="text-white/80 text-sm lg:text-base">{t('landing.cta.stats.activeSpecialists')}</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl lg:text-4xl font-bold mb-2">4.8★</div>
                  <div className="text-white/80 text-sm lg:text-base">{t('landing.cta.stats.averageRating')}</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl lg:text-4xl font-bold mb-2">24/7</div>
                  <div className="text-white/80 text-sm lg:text-base">{t('landing.cta.stats.support')}</div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Button 
                  size="lg"
                  className="bg-white text-primary-600 hover:bg-gray-50 hover:scale-105 transition-all duration-200 px-8 py-4 text-lg font-semibold shadow-xl"
                  asChild
                >
                ...
                <Button 
                  size="lg"
                  variant="outline"
                  className="border-2 border-white text-white hover:bg-white hover:text-primary-600 hover:scale-105 transition-all duration-200 px-8 py-4 text-lg font-semibold"
                  asChild
                >
