...
const resources = {
  en: {
    translation: {
      ...
      "landing.howItWorks.customers.step2.description": "Verified specialists will apply with availability and timelines for your task",
      ...
      "landing.howItWorks.professionals.step2.description": "Browse tasks, send proposals with availability and timelines",
      "landing.howItWorks.professionals.step3.title": "Work & Help",
      "landing.howItWorks.professionals.step3.description": "Complete the task with quality and build your reputation",
      
      "landing.forProfessionals.subtitle": "Join thousands of verified specialists and help your community",
      ...
      "landing.forProfessionals.becomeProDesc": "Offer your services and help others",
      ...
      "landing.cta.freeToJoin": "Free to join • Community-driven • Open platform",
  ...
  bg: {
    translation: {
      ...
      "landing.howItWorks.professionals.step3.title": "Работете и помагайте",
      "landing.howItWorks.professionals.step3.description": "Изпълнете задачата качествено и изградете своята репутация",
      
      "landing.forProfessionals.subtitle": "Присъединете се към хиляди верифицирани специалисти и помогнете на общността",
      ...
      "landing.forProfessionals.becomeProDesc": "Предлагайте своите услуги и помагайте на други",
      ...
      "landing.cta.freeToJoin": "Безплатна регистрация • Управлявана от общността • Отворена платформа",
  ...
  ru: {
    translation: {
      ...
      "landing.trustIndicators.freeToUse": "Бесплатно для использования",
      ...
      "landing.howItWorks.professionals.step3.title": "Работайте и помогайте",
      "landing.howItWorks.professionals.step3.description": "Выполняйте задачи качественно и создавайте свою репутацию",
      
      "landing.forProfessionals.subtitle": "Присоединяйтесь к тысячам верифицированных специалистов и помогайте сообществу",
      ...
      "landing.forProfessionals.becomeProDesc": "Предлагайте свои услуги и помогайте другим",
      
      // Final CTA Section
      "landing.cta.title": "Готовы трансформировать ваши задачи?",
      "landing.cta.subtitle": "Присоединяйтесь к самой надежной платформе Болгарии, связывающей клиентов с верифицированными местными специалистами для всех ваших потребностей",
      "landing.cta.postTask": "Разместить задачу",
      "landing.cta.joinProfessionals": "Присоединиться как специалист",
      "landing.cta.freeToJoin": "Бесплатная регистрация • Управляемая сообществом • Открытая платформа",
